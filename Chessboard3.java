...
public class Chessboard3{
  ...
  public static void main(String[]args){
    ...
    while (c.KingAlive){
      ...
      while (c.counter%2==0 && c.KingAlive){
        String bturn;
  ...
  public void anotherRound(Chessboard3 c){
  ...
  public void gameAgain(Chessboard3 c){
    Scanner user_input = new Scanner(System.in);
    c.KingAlive = true;
    c.counter = 1;
    System.out.println(c); // prints chessboard
...
public void fillInPiecesStart(){
  ...
  for (int insertPawn = 0; insertPawn < 8; insertPawn++){
    Pawn wp1 = new Pawn(insertPawn, 1, 'b');
    cb[1][insertPawn] = wp1;
  }
  //Pawns for PlayerB
  for (int insertPawn = 0; insertPawn < 8; insertPawn++){
    Pawn wp1 = new Pawn(insertPawn, 6, 'a');
    //cb[1][insertPawn] = wp1;
...
*/
public static boolean doAction(String string,Chesspieces[][] chb, Chessboard3 c){
